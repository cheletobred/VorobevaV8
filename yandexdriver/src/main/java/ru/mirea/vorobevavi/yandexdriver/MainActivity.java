...
import ru.mirea.vorobevavi.yandexdriver.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener{
    ...
    private final Point ROUTE_END_LOCATION = new Point(55.741841, 37.620154);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marker.addTapListener(new MapObjectTapListener() {
            public boolean onMapObjectTap(@NonNull MapObject mapObject, @NonNull Point
                ...
                builder.setMessage("Название:Государственная Третьяковская галерея \nАдрес: Лаврушинский пер., 10, стр. 4 \n Коротко о месте: Государственный музей изобразительных искусств имени А.С. Пушкина, также известный как Третьяковская галерея, является одним из крупнейших и наиболее значимых художественных музеев в мире. ");
